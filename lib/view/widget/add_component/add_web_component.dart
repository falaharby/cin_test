...
class AddWebComponent extends StatefulWidget {
  final VoidCallback? onTap;
  final Alamat? updateData;
  const AddWebComponent({super.key, this.onTap, this.updateData});

  @override
  State<AddWebComponent> createState() => _AddWebComponentState();
}

class _AddWebComponentState extends State<AddWebComponent> {
